...
const styles = StyleSheet.create({
  ...
  body: { padding: 16, paddingBottom: 15 }, titleRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginBottom: 8 }, title: { ...TypeScale.h3, fontFamily: FontFamily.headingBold, color: AppColors.text, flex: 1 }, subBadges: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 6 },
  ...
  footer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginHorizontal: 16, paddingTop: 14, paddingBottom: 16, borderTopWidth: 1, borderTopColor: AppColors.border }, host: { flexDirection: 'row', alignItems: 'center', gap: 9, flex: 1, minWidth: 0 }, hostCopy: { flex: 1, minWidth: 0 }, avatar: { width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, avatarText: { color: AppColors.surface, fontFamily: FontFamily.headingBold, fontSize: 15 }, hostName: { flexDirection: 'row', alignItems: 'center', gap: 5 }, hostText: { ...TypeScale.label, color: AppColors.text, flexShrink: 1 }, people: { fontFamily: FontFamily.body, fontSize: 10, lineHeight: 14, color: AppColors.textSecondary },
